          ...
          {Object.keys(tableStatus).length > 0 && (
            <Box sx={{ mb: 3 }}>
              ...
              {!tableStatus["recipes"] && (
                ...
                >
                  The recipes table doesn&apos;t exist. Please run the migration
                  script in the Supabase SQL Editor. You can find the script at:{" "}
                  <code>
                    supabase/migrations/20250302175711_shrill_canyon.sql
                  </code>
                </Typography>
              )}
              ...
              {(!tableStatus["tags"] || !tableStatus["recipe_tags"]) && (
                <Typography
                  ...
                  sx={{ mt: 2, color: "text.secondary" }}
                >
                  The tags and/or recipe_tags tables don&apos;t exist. Please
                  run the migration script in the Supabase SQL Editor. You can
                  find the script at:{" "}
