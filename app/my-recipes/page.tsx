 ...
 *
 * This page displays a user's collection of recipes. It includes:
 * - Authentication check to ensure user is logged in
 * - Fetches and displays user's recipes from Supabase
 * - Provides an "Add Recipe" button to create new recipes
 * - Shows a loading state while fetching data
 * - Displays recipes in a responsive grid layout
 * - Shows an empty state message when no recipes exist
 */
